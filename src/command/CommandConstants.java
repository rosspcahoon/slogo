...
public class CommandConstants {
    ...
    public static final String COMMAND_NAME_FD = "fd";
    public static final String COMMAND_NAME_BACK = "back";
    public static final String COMMAND_NAME_BK = "bk";
    public static final String COMMAND_NAME_LEFT = "left";
    public static final String COMMAND_NAME_LT = "lt";
    public static final String COMMAND_NAME_RIGHT = "right";
    public static final String COMMAND_NAME_RT = "rt";
    public static final String COMMAND_NAME_SET_HEADING = "setheading";
    public static final String COMMAND_NAME_SETH = "seth";
    ...
    public static final String COMMAND_NAME_PD = "pd";
    public static final String COMMAND_NAME_PENUP = "penup";
    public static final String COMMAND_NAME_PU = "pu";
    public static final String COMMAND_NAME_SHOW_TURTLE = "showturtle";
    public static final String COMMAND_NAME_ST = "st";
    public static final String COMMAND_NAME_HIDE_TURTLE = "hideturtle";
    public static final String COMMAND_NAME_HT = "ht";
    public static final String COMMAND_NAME_HOME = "home";
    public static final String COMMAND_NAME_CLEAR_SCREEN = "clearscreen";
    public static final String COMMAND_NAME_CS = "cs";
    
    // command arg names
    public static final String COMMAND_ARG_PIXELS = "pixels";
    public static final String COMMAND_ARG_DEGREES = "degrees";
