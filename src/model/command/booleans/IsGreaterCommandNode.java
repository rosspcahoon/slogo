...
/**
 * Node representing a GREATER test command
 * @author james
 *
 */
public class IsGreaterCommandNode extends CommandNode {

    public IsGreaterCommandNode() {
        super();
    ...
    public CommandNode getCopyOfInstance () {
        return new IsGreaterCommandNode();
    }
